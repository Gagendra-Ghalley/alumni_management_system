        ...
        <div id="page-wrapper">
            ...
            <div class="row profile">
                <div class="col-md-4">
                  ...
                  <form class="form-horizontal"   id="f" action="<?php echo base_url();?>index.php/Settings/viewmember1" method="post" style="background-color: white; width:550px;padding:10px"></form>
