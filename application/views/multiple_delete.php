 ...
 <div class="table-responsive">
  <table class="table table-bordered">
   ...
   foreach($employee_data->result() as $row)
   {
    echo '
    <tr>
     <td><input type="checkbox" class="delete_checkbox" value="'.$row->relatedUserId.'" /></td>
     <td>'.$row->FirstName.'</td>
     <td>'.$row->gender.'</td>
...
$(document).ready(function(){
 ...
 $('#delete_all').click(function(){
  ...
  if(checkbox.length > 0)
  {
   ...
   $.ajax({
    url:"<?php echo base_url(); ?>index.php/multiple_delete/delete_all",
    method:"POST",
