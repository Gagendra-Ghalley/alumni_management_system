        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="<?php echo base_url()?>index.php/Settings/passwordemail/"><i class="fa fa-key"></i>&nbsp;Forget password(users)</a>
                    </li>
                   ...
                   <!--  <li>
                    ...
                    <li>
                        <a href="#"><i class="fa  fa-calendar-o"></i>&nbspManage Events<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
