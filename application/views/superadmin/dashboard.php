               ...
               <!--  <?php if($pendingLeave>0){?></a><?php }?>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="panel-body yellow text-center"style="height: 140px" >
                      <a href="<?php echo base_url();?>index.php/Settings/viewUsers/">
                       <i class= "fa fa-user fa-5x"aria-hidden="true"></i>&nbsp;<br/><br/><strong>Manage User</strong>

                    </div>
                    <div class="panel-footer">
                            <span class="panel-eyecandy-title"><strong><b style="color:#97839c; font-size:18px"> 
                              <i class="fa fa-user">&nbsp</i>Manage User</a></b></strong>
