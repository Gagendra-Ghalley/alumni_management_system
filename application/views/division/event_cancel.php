             ...
             <?php foreach($editdetail as $row): ?>
               ...
               <div class="col-lg-5 col-md-5 col-sm-4 img-responsive" >
                        ...
                        <div class="hovereffect">
                            <figure> <img class="card-imd-top-top" src="<?php echo base_url();?>assets/img/event/<?php echo $row['image'];?>" style="height: 100%;width:100%;" ></figure>
...
<table>
            ...
            <div class="col-md-2 col-sm-12 col-lg-2 " style="height: 210px;">
                ...
                <input type="submit" value="Cancel" style="height:40px;font-size:15px;width: 120px" class="btn btn-primary text-left" data-animation="animated zoomInUp">
                                   ...
                                   <button class="btn btn-success btn-lg" style="height:70px;width:120px;font-size:15px;font-family:georgia;text-shadow: 1px 1px 1px #111">  
                                        <p><font color="black">
                                          <?php echo $row['event1'];?>
