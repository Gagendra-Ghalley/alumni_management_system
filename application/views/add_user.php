      ...
      <form method="post" action="<?php echo base_url()?>index.php/Settings/form_validation_add_user">  
          ...
          <!--  <div class="form-group">  
           ...
           <div class="form-group">  
                ...
                <input style="width:400px;" placeholder="Enter Department" type="text" name="gender1" id="gender1" class="form-control"  />  
                <span class="text-danger"><?php echo form_error("gender1"); ?></span>  
           </div>
           <div class="form-group">  
                <label class="col-sm-3 col-md-4 col-lg-2 control-label">Enter Year of graduation</label>  
                <input style="width:400px;" placeholder="Enter Year of graduation" type="text" name="gender2" id="gender2" class="form-control"  />  
                <span class="text-danger"><?php echo form_error("gender2"); ?></span>  
           </div>
            <div class="form-group">  
                <label class="col-sm-3 col-md-8 col-lg-2 control-label">Select Department(ID)</label>  
            ...
            <?php endforeach; ?>
              ...
              <div class="form-group">  
                <label class="col-sm-3 col-md-4 col-lg-2 control-label">Select Year of graduation(ID)</label> 
