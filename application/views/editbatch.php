...
<html>  
 ...
 <?php $row=$employee->row(0);
    ...
    ?>
            ...
            <div class="row">
                <form method="post" accept-charset="utf-8" action="<?php echo base_url();?>index.php/Settings/updatebatch/<?php echo $cid;?>/" class="form-group">
   ...
   <div class="panel-body login">
          ...
          <div id="errorsupdate"><?php echo validation_errors();?></div></div>
           ...
           <form >
               <div class="col-lg-6">
               <a href="<?php echo base_url();?>index.php/Settings/managebatch/" class="btn btn-lg btn-warning btn-block">Back</a>
           </div>
           </form>
