...
<div class="row">
	<div class="col-xs-12">
		<div id="loadcontenthere">
			<form class="form-horizontal" role="form" id="fileaddformdak" enctype="multipart/form-data" action="<?php echo site_url('UserManagement/addDak');?>" method="POST">
			...
			<div class="form-group" id="addId" style="display: none">
				...
				<div class="col-xs-12 col-sm-5 col-md-5">
					<input type="text"  value= "<?php echo $this->session->userdata('name');?>"  id="subject" class="form-control" name="Recieved_by" placeholder="Insert Recieved By"/>
				</div>
			...
			<div class="form-group">
				...
				<div class="col-xs-12 col-sm-5 col-md-5">
					<input type="file" name="letterAttachment" id="Attachment">
...
<script type="text/javascript">
	...
	function addfile(){
		...
		$('#lastweqno').val(parseInt($('#seqNo').val())+1);
	...
	function showfilename(){
		if($('#RletterNo').val()!=""){
			...
			$('#RletterNo').html('Please provide letter number you recieved	');
		}
