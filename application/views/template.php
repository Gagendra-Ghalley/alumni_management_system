        ...
        <div class="main-container" id="main-container">
            ...
            <div class="main-content">
                <!-- use this id to load all page content here! -->
                    ...
                    <div id="loadcontent">
                         <?php $this->load->view('base/breadcrumb');?>
                        <div class="page-content">  
                           <li class="#loadcontent">
            <a href="#"  onclick="openMessage('<?php echo site_url();?>/Settings/message_dashboard/')">
                ...
                <span class="menu-text"> Check for Forwarded Messages</span>
                
            </a>

            <b class="arrow"></b>
        </li>
                           <!-- <?php //$this->load->//view('ods_dashboard');?>  -->
...
<script type="text/javascript">
    ...
    //  function loadPagcontente(url){
    //     $("#loadcontent").load(url+'/'+$('#cidNum').val());
    // }

    function loadPagcontente(url){
        // $("#loadcontent").load($('#cidNum').val());
        $("#loadcontent").load(url+'/'+$('#cidNum').val());
    }

    function loadPagcontente1(url) {
        $("#loadcontent").load(url+'/'+$('#cidNum1').val());
    }
