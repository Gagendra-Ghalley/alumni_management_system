	...
	<div class="panel panel-primary">
        <div class="panel-heading">
                               ...
                               <form>
                               	...
                               	<input type="text" name="month" id="month" style="color:#000;" placeholder="Month" size="5px"/><input type="text" id="year" name="year" style="color:#000;" placeholder="Year" size="5px"/>
